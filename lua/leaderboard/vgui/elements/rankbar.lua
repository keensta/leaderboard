...
function RB:Paint(w, h)
	...
	if ( tonumber(self.Pos) <= 3 ) then
		...
		draw.SimpleText(self.Pos, "LB_Board", 14.05, 12.25, LB.RankBarText, TEXT_ALIGN_LEFT)
		draw.RoundedBox(6, 110, 7, UL, 25, LB.RankBarTextBg)
		draw.SimpleText(self.Username, "LB_Board", 115, 12.5, LB.RankBarText, TEXT_ALIGN_LEFT)
		draw.RoundedBox(6, 431.5 - SL / 2, 7, SL, 25, LB.RankBarTextBg)
		draw.SimpleText(self.Score, "LB_Board", 434 - SL / 2, 12.5, LB.RankBarText, TEXT_ALIGN_LEFT)
	else
		surface.SetFont("LB_Board")
